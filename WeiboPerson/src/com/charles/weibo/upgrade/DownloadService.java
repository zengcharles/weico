...
import com.charles.weibo.upgrade.NotificationUpdateActivity.ICallbackResult;
...
public class DownloadService extends Service {
	...
	// 返回的安装包url
	private String apkUrl = Config.UPDATE_APP_URL;
	// private String apkUrl = MyApp.downloadApkUrl;
	/* 下载包安装路径 */
	private static final String savePath = "/sdcard/updateApkDemo/";

	private static final String saveFileName = savePath + "Weibo.apk";
