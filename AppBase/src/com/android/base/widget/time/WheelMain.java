package com.android.base.widget.time;
...
//		int day = calendar.get(Calendar.DATE);
	...
	public String getWeekString(){
		return DateUtil.getWeekDayString((wv_year.getCurrentItem()+START_YEAR), (wv_month.getCurrentItem() + 1), (wv_day.getCurrentItem() + 1));
	}
}
